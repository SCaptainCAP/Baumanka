...
int main()
{
	...
	GraphShower gsh1 = GraphShower("/tmp/f1.data", "Old graph", "/tmp/pic1.png");
	GraphShower gsh2 = GraphShower("/tmp/f2.data", "New graph", "/tmp/pic2.png");
	for (int i = 0; i < n; ++i)
	...
	cout << "Ребер удалено: " << remove_counter << endl;
	gsh2.show();
	best_cut.empty();
